...
<body>
				...
				<div class="row fullscreen justify-content-center align-items-center">
					<div class="col-md-10 col-12">
						<div class="banner-content text-center">
							...
							<h1 class="text-uppercase text-white">Berita Mengenai Jember</h1>
						</div>
					</div>
			...
			<div class="container">
				<div class="row fullscreen justify-content-center align-items-center">
					<div class="col-md-10 col-12">
						<div class="banner-content text-center">
							<h4 class="text-white mb-20 text-uppercase">Jelajahi Dunia Yang Penuh Warna Ini</h4>
							<h1 class="text-uppercase text-white">Edukasi</h1>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="whole-wrap">
		<div class="container">
			<?php
				$sql = "SELECT * FROM tb_event ORDER BY idEvent DESC";
				...
				while ($data = mysqli_fetch_array($query)) {
					...
					<?php } ?>
					<h3 class="mb-30"><?= $data['namaEvent']; ?></h3>
					<div class="row">
						<div class="col-md-3">
							<img src="../../assets/uploads/events/<?= $data['gambar']; ?>" alt="" class="img-fluid">
						</div>
