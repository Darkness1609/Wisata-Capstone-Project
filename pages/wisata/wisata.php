...
<body>
				...
				<div class="row fullscreen justify-content-center align-items-center">
					<div class="col-md-10 col-12">
						<div class="banner-content text-center">
							...
							<h1 class="text-uppercase text-white">Temukan Wisata Yang Belum Anda Kunjungi</h1>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="whole-wrap">
        <div class="container">
			<?php
				$sql = "SELECT * FROM tb_wisata ORDER BY idWisata DESC";
				...
				while ($data = mysqli_fetch_array($query)) {
					...
					<?php } ?>
					<h3 class="mb-30"><?= $data['namaWisata']; ?></h3>
					<div class="row">
						<div class="col-md-3">
							<img src="../../assets/uploads/wisata/<?= $data['gambar']; ?>" alt="" class="img-fluid">
						</div>
